...
// Export social icons array for easy usage
...
export const getSocialIcons = (size: string = "w-6 h-6") => [
  { icon: <FacebookIcon className={size} />, url: '#', label: 'Facebook' },
  { icon: <TikTokIcon className={size} />, url: '#', label: 'TikTok' },
  { icon: <InstagramIcon className={size} />, url: '#', label: 'Instagram' },
  { icon: <YouTubeIcon className={size} />, url: '#', label: 'YouTube' },
];